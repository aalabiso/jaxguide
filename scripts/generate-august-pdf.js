...
async function main() {
    ...
    const htmlFile = path.join(projectRoot, 'print-sources', 'august-events.html');
    const pdfFile = path.join(projectRoot, 'print-sources', 'Jacksonville-August-2026-Events.pdf');
    const publicPdf = path.join(projectRoot, 'public', 'Jacksonville-August-2026-Events.pdf');

    console.log('Generating August Events PDF...');
