...
async function main() {
    ...
    const htmlFile = path.join(projectRoot, 'print-sources', 'april-events.html');
    const pdfFile = path.join(projectRoot, 'print-sources', 'Jacksonville-April-2026-Events.pdf');
    const publicPdf = path.join(projectRoot, 'public', 'Jacksonville-April-2026-Events.pdf');

    console.log('Generating April Events PDF...');
